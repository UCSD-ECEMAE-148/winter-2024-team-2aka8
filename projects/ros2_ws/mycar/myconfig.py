...
#This stuff is copied from the other myconfig.py in d4 to try and make this one work
...
VESC_STEERING_SCALE= 0.5 # VESC accepts steering inputs from 0 to 1. 
#Joystick is usually -1 to 1. This changes it to -0.5 to 0.5
...
# JOYSTICK_MAX_THROTTLE = 1         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don'$
# JOYSTICK_STEERING_SCALE = 1.0       #some people want a steering that is less sensitve. This scalar is multiplied with the steering -1 to 1. It can be negative to reverse dir.
# AUTO_RECORD_ON_THROTTLE = True      #if true, we will record whenever throttle is not zero. if false, you must manually toggle recording with some other trigger. Usually circle $
...
GPS_SERIAL = '/dev/ttyUSB2' # serial device path, like '/dev/ttyAMA1' or '/dev/ttyUSB0'
GPS_SERIAL_BAUDRATE = 468000
#GPS_NMEA_PATH = gps_coords.csv        # File used to record gps, like "nmea.csv".
#                             # If this is set then when waypoints are recorded then
#                             # the underlying NMEA sentences will also be saved to
#                           doc  # this file along with their time stamps.  Then when
...
# # PATH FOLLOWING
# #
PATH_FILENAME = "/home/projects/ros2_ws/src/ucsd_robocar_hub2/ucsd_robocar_basics2_pkg/ucsd_robocar_basics2_pkg/donkey_paths/chat_gps.csv"   # the path will be saved to this filename as comma separated x,y values
#PATH_FILENAME = "zigzag.csv"
...
PATH_LOOK_AHEAD = 5                 # number of points ahead of the closest point to include in cte track
PATH_LOOK_BEHIND = 5                # number of points behind the closest point to include in cte track   
PID_P = 0.3                        # proportional mult for PID path follower
PID_I = 0.000                       # integral mult for PID path follower
PID_D = 0.2                        # differential mult for PID path follower
PID_THROTTLE = 0.20                 # constant throttle value during path following
